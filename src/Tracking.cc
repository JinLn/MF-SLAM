...
//        catch(int d){
//            if (d == 0)
//            cerr << "Want to get K_l... "<<endl;
//        }
//        catch(int d){
//            if (d == -1)
//            cerr << "Don't get K_l... "<<endl;
//        }
//        fSettings["LEFT.K"] >> K_l;
...
//        cout<<"rows_l=" <<rows_l<<" cols_l="<<cols_l<<" rows_r="<<rows_r<<" cols_r="<<cols_r<<endl;
//        //参数合法性检查(不为空就行)
    ...
    void Tracking::Track() {
        ...
        if(mState == NOT_INITIALIZED) {
            ...
            if(bOK || mState == RECENTLY_LOST) {
                ...
                // cout<< "CreateNewKeyFrame front"<<endl;
...
//    cout <<"nTrackedClose= "<<setw(4) << nTrackedClose <<"\tnNonTrackedClose= "<<setw(4)<< nNonTrackedClose <<"\tnTotal= "
//        << setw(4)<< nTrackedClose + nNonTrackedClose << "\tratioMap_Tracked= "<< setw(6)<< (float)nTrackedClose / (nTrackedClose + nNonTrackedClose) <<endl;
        ...
        // cout <<"表示上一帧到当前帧的变换:"<< mVelocity << endl;
...
//    cout<< "上一帧到当前帧的变换:"<<endl;
//    printMat(mVelocity);
        // cout<< mVelocity.at<float>(2,0) << endl;
        // printMat(mCurrentFrame.mTcw);
    }
